//////////////////////////////////////////////////
// SOLUCION USANDO GRADIENT-BOOST REGRESSION ////
////////////////////////////////////////////////
...
// Este metodo de regresion usa varios arboles de decision ensamblados.
// GBT entrena iterativamente varios arboles de decision para minimizar
...
val gbtdata = (data.select(data("EP").as("label"), $"T", $"V", $"AP", $"RH"))
...
val Array(training, test) = gbtdata.randomSplit(Array(0.7, 0.3))
